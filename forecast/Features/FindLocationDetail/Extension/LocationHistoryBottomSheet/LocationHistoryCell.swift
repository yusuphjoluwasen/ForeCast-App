...
class LocationHistoryCell:UICollectionViewCell, UIGestureRecognizerDelegate{
    ...
    lazy var descLabel: UILabel = {
        let header = UILabel()
        header.translatesAutoresizingMaskIntoConstraints = false
        header.setUpGenLabel(text: "", textColor: .foreCastColorGray2, font: .systemFont(ofSize: 12, weight: .regular))
        return header
    }()
    ...
    lazy var tempLabel: UILabel = {
        let header = UILabel()
        header.translatesAutoresizingMaskIntoConstraints = false
        header.setUpGenLabel(text: "", textColor: .foreCastPurpleBlue, font: .systemFont(ofSize: 18, weight: .bold))
        return header
    }()
    ...
    lazy var descImage: ImageLoader = {
        ...
        header.translatesAutoresizingMaskIntoConstraints = false
        header.setUpImageView(image: FindLocationDetailStringConstants.string.tempimage, contentMode: .scaleToFill)
        return header
    }()
    ...
    func setUpConstraintAndProperties(){
        ...
        locationLabel.widthAnchor.constraint(equalToConstant: 100).isActive = true
        ...
        deleteLabel1.text = FindLocationDetailStringConstants.string.delete
        deleteLabel1.textColor = UIColor.white
        self.insertSubview(deleteLabel1, belowSubview: self.contentView)
        
        deleteLabel2 = UILabel()
        deleteLabel2.text = FindLocationDetailStringConstants.string.delete
